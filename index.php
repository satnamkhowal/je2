    ...
    <div id="rs-popular-courses" class="rs-popular-courses style1 orange-color modify1 pt-100 pb-100 md-pt-70 md-pb-70">
        <div class="container">
            <div class="sec-title6 text-center mb-40">
                ...
                <p>Choose a practical learning path based on your career goal and technology interest.</p>
            </div>

            <div class="gridFilter style2 text-center mb-30">
                <button class="active" data-filter="*">All</button>
                <button data-filter=".filter1">Full Stack</button>
                <button data-filter=".filter2">Java &amp; Python</button>
                <button data-filter=".filter3">Data &amp; AI</button>
                <button data-filter=".filter4">Cloud &amp; Security</button>
            </div>
            ...
            <div class="row grid">
                <div class="col-lg-4 col-md-6 grid-item filter1">
                    <div class="courses-item mb-30">
                        <div class="img-part">
                            <a href="full-stack-development-course-jaipur.php"><img src="assets/images/courses/home14/1.jpg" width="600" height="400" loading="lazy" alt="Full Stack Development course in Jaipur at Jaipur Engineers"></a>
                        </div>
                        <div class="content-part">
                            <ul class="meta-part"><li><span class="price">Career Program</span></li></ul>
                            <h3 class="title"><a href="full-stack-development-course-jaipur.php">Full Stack Development Course in Jaipur</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item filter1 filter2">
                    <div class="courses-item mb-30">
                        ...
                        <div class="content-part">
                            ...
                            <a class="je-java-card-cta" href="java-full-stack-course-jaipur.php">View Course Details <i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item filter2">
                    <div class="courses-item mb-30">
                        <div class="img-part">
                            <a href="python-programming-course-jaipur.php"><img src="assets/images/courses/home14/3.jpg" width="600" height="400" loading="lazy" alt="Python Programming course in Jaipur at Jaipur Engineers"></a>
                        </div>
                        <div class="content-part">
                            <ul class="meta-part"><li><span class="price">Programming</span></li></ul>
                            <h3 class="title"><a href="python-programming-course-jaipur.php">Python Programming Course in Jaipur</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item filter3">
                    <div class="courses-item md-mb-30">
                        ...
                        <div class="content-part">
                            ...
                            <h3 class="title"><a href="data-science-course-jaipur.php">Data Science &amp; AI Course in Jaipur</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item filter4">
                    <div class="courses-item sm-mb-30">
                        ...
                        <div class="content-part">
                            ...
                            <h3 class="title"><a href="cloud-computing-course-jaipur.php">Cloud Computing &amp; DevOps Training in Jaipur</a></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item filter4">
                    <div class="courses-item">
                        ...
                        <div class="content-part">
                            ...
                            <h3 class="title"><a href="cyber-security-course-jaipur.php">Cyber Security Course in Jaipur</a></h3>
                        </div>
                    </div>
                </div>
            </div>
