...
========================================================== -->
<footer id="rs-footer" class="rs-footer home9-style main-home home14-style je-rich-footer">

    <div class="je-footer-cta">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-8">
                    <span class="je-footer-kicker">Build Skills. Build Projects. Build Your Career.</span>
                    <h3>Looking for the right IT course in Jaipur?</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-widget md-mb-50">
                    ...
                    <ul class="footer_social">
                        <li><a href="https://www.facebook.com/JaipurEngineersTrainings/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><span><i class="fa fa-facebook"></i></span></a></li>
                        <li><a href="https://x.com/Jaipur_Engineer" target="_blank" rel="noopener noreferrer" aria-label="X"><span><i class="fa fa-twitter"></i></span></a></li>
                        <li><a href="https://www.linkedin.com/company/jaipurengineers" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><span><i class="fa fa-linkedin"></i></span></a></li>
                        <li><a href="https://www.instagram.com/jaipurengineerstrainings/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><span><i class="fa fa-instagram"></i></span></a></li>
                        <li><a href="https://www.youtube.com/@JaipurEngineers" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><span><i class="fa fa-youtube-play"></i></span></a></li>
                    </ul>
                </div>

                <div class="col-lg-3 col-md-6 col-sm-12 footer-widget md-mb-50">
                    <h3 class="widget-title">Contact Jaipur Engineers</h3>
        ...
        <div class="container">
            <div class="row y-middle">
                <div class="col-lg-6 md-mb-20">
                    <div class="copyright">
                        <p>&copy; <?php echo date('Y'); ?> Jaipur Engineers. All Rights Reserved.</p>
                    </div>
                </div>
